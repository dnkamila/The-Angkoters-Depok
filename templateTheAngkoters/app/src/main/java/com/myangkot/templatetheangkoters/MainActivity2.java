...
public class MainActivity2 extends ActionBarActivity {
    ...
    int ICONS[] = {R.drawable.ic_launcher,R.drawable.nearby_light,R.drawable.favorite_light,R.drawable.angkot_details_light,R.drawable.twitter_light,R.drawable.setting_light,R.drawable.user_guide_light,R.drawable.feedback_us_light,R.drawable.about_light, R.drawable.ic_launcher};
    ...
    private void displayView(int position) {
        ...
        Fragment fragment = null;
            ...
            case 3:
                ...
                break;
            case 4:
                fragment = new Angkot_Details();
                break;
            case 5:
                fragment = new Angkot_News();
                break;
            case 6:
                fragment = new Angkot_Details();
                break;
